...
{% if store.whatsapp %}
	<li class="contact-item{% if columns %} col-6 col-md{% endif %}"><i class="footer-icon fab fa-lg fa-fw fa-whatsapp{% if columns %} contact-icon{% else %} mx-2{% endif %}"></i><a href="{{ store.whatsapp }}" class="contact-link">{{ store.whatsapp }}</a></li>
{% elseif store.phone %}
